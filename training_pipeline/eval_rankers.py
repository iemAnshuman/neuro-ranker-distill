...
# Fix: Save report to local directory instead of Google Drive
...
print(f"BM25: NDCG@{args.k}={avg_ndcg_b:.3f} MRR@{args.k}={avg_mrr_b:.3f}")
print(f"Teach: NDCG@{args.k}={avg_ndcg_t:.3f} MRR@{args.k}={avg_mrr_t:.3f}")
print(f"Stud.: NDCG@{args.k}={avg_ndcg_s:.3f} MRR@{args.k}={avg_mrr_s:.3f}")